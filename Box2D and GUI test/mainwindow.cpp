...
MainWindow::MainWindow(QWidget *parent)
{
   ...
   //Start Button
    ...
    //myWorld->Step(1.0/100.0, 8.0, 3.0);
    ...
    elem  = new MeinElement(myWorld, level, QPointF(81.0,40.0), 0, b2_dynamicBody, circle);
    elem1 = new MeinElement(myWorld, level, QPointF(80.0,170), 0, b2_staticBody, circle);
    elem2 = new MeinElement(myWorld, level, QPointF(120.0,500.0), 0, b2_staticBody, circle);
    elem3 = new MeinElement(myWorld, level, b2Vec2 (90.0,170.0), 0, 200, 100, b2_staticBody,1.0);
