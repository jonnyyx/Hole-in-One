    ...
    QList <QString> levelenab;
        ...
        if(levelenab.size()>14){
            if(levelenab.at(16).toInt()<highscore){
                    ...
                    newhighscore=true;
                }else if(levelenab.at(16).toInt()==highscore){
...
void Level_4::showLevel(){
     ...
     ball  = new Paperball(myWorld4, level4, QPointF(540.0,46.0), 0*(3.14/180.0), b2_dynamicBody, circle);
