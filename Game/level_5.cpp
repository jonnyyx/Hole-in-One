...
Level_5::Level_5()
{
    ...
    //Scene setup
    level5 = new QGraphicsScene();
    level5->setSceneRect(0,0,1024,768);
    setScene(level5);
...
void Level_5::update(){
    ...
    win = ball->drawBall1(); //nur bewegende Elemente in Update
        ...
        msgbox = new MeinElement(level5,QPointF(375,275),300,175);
...
/*!
 * \brief Level_5::pauseLevel
 * pauses game when button pause is clicked
 */
void Level_5::pauseLevel(){
    if(timer!=NULL){
        timer->stop();
    }
    Level_5::getTime();
    Level_5::highscoreCounter();
...
/*!
 * \brief Level_5::resumeLevel
 * resumes game when button resume is clicked
 */
void Level_5::resumeLevel()
{
    timer->start();
    bt_pause->setEnabled(true);
    bt__resume->setEnabled(false);
...
/*!
 * \brief Level_5::addRectangle
 * Create new rectangle and count the rectangle items. limited to number.
 */
void Level_5::addRectangle()
{
    counterRec++;


    if (counterRec==1){
        addblock1 = new Block(myWorld4, level5, b2Vec2 (50.0,20.0), 0, 100, 40, b2_staticBody,1.0,"tool");
        ...
        addblock2 = new Block(myWorld4, level5, b2Vec2 (50.0,20.0), 0, 100, 40, b2_staticBody,1.0,"tool");
...
void Level_5::addCircle(){
    ...
    if(counterCircle==1){
        ...
        addcircle1 = new Circle(myWorld4, level5, QPointF(0.0,0.0), 0*(3.14/180.0), b2_staticBody, circle,"tool");
    ...
    if(counterCircle==2){
        circle.m_radius = 21.0;
        addcircle2 = new Circle(myWorld4, level5, QPointF(0.0,0.0), 0*(3.14/180.0), b2_staticBody, circle,"tool");
...
/*!
 * \brief Level_5::addTriangle
 * Create new Triangle and count the triangle items. Limited to number.
 */
void Level_5::addTriangle()
{
    counterTriangle++;

    if(counterTriangle==1){
        addtriangle1 = new Triangle(myWorld4, level5, QPointF(0.0,0.0), QPointF(100.0,0.0), QPointF(100.0,100.0), 0, b2_staticBody, 1.0,"tool");
    ...
    if(counterTriangle==2){
        addtriangle2 = new Triangle(myWorld4, level5, QPointF(0.0,0.0), QPointF(100.0,0.0), QPointF(100.0,100.0), 0, b2_staticBody, 1.0,"tool");
...
void Level_5::showLevel(){
     ...
     umrandung1 = new MeinElement(myWorld4,level5, b2Vec2 (-30.0,0.0), 10, 1024, b2_staticBody, 1.0);
     umrandung2 = new MeinElement(myWorld4,level5, b2Vec2 (1002.0,0.0), 0, 1024, b2_staticBody, 1.0);

     ball  = new Paperball(myWorld4, level5, QPointF(540.0,20.0), 0*(3.14/180.0), b2_dynamicBody, circle);

     obstaclescircle1 = new Circle(myWorld4, level5, QPointF(0.0,547), 0*(3.14/180.0), b2_staticBody, circle,"obs");


     //obstaclesrec1=new Block(myWorld4,level5,b2Vec2(200,100),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec2=new Block(myWorld4,level5,b2Vec2(300,100),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec2=new Block(myWorld4,level5,b2Vec2(400,100),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec3=new Block(myWorld4,level5,b2Vec2(500,100),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec4=new Block(myWorld4,level5,b2Vec2(600,100),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec5=new Block(myWorld4,level5,b2Vec2(100,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec6=new Block(myWorld4,level5,b2Vec2(200,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec7=new Block(myWorld4,level5,b2Vec2(300,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec8=new Block(myWorld4,level5,b2Vec2(500,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec9=new Block(myWorld4,level5,b2Vec2(600,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec10=new Block(myWorld4,level5,b2Vec2(700,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec11=new Block(myWorld4,level5,b2Vec2(800,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec12=new Block(myWorld4,level5,b2Vec2(900,225),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec13=new Block(myWorld4,level5,b2Vec2(350,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec14=new Block(myWorld4,level5,b2Vec2(450,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec15=new Block(myWorld4,level5,b2Vec2(550,400),0,100,40,b2_staticBody,1.0,"obs");
     //obstaclesrec16=new Block(myWorld4,level5,b2Vec2(200,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec17=new Block(myWorld4,level5,b2Vec2(100,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec18=new Block(myWorld4,level5,b2Vec2(0,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec19=new Block(myWorld4,level5,b2Vec2(750,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec20=new Block(myWorld4,level5,b2Vec2(850,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec21=new Block(myWorld4,level5,b2Vec2(950,400),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec22=new Block(myWorld4,level5,b2Vec2(200,500),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec23=new Block(myWorld4,level5,b2Vec2(300,500),0,100,40,b2_staticBody,1.0,"obs");
     obstaclesrec24=new Block(myWorld4,level5,b2Vec2(1000,225),0,100,40,b2_staticBody,1.0,"obs");
     //obstaclesrec25=new Block(myWorld4,level5,b2Vec2(530,380),0,100,40,b2_staticBody,1.0,"obs");

     obstacletriangle1=new Triangle(myWorld4,level5,QPointF(300,280),QPointF(400,280),QPointF(400,380),1.57,b2_staticBody,1.0,"obs");
     obstacletriangle2=new Triangle(myWorld4,level5,QPointF(400,280),QPointF(500,280),QPointF(500,380),3.1415,b2_staticBody,1.0,"obs");


     recyclebin1 = new RecycleBin(myWorld4, level5, QPointF(500,508),QPointF(510,508),QPointF(530,568),QPointF(520,568), 0.0, b2_staticBody);
     recyclebin2 = new RecycleBin(myWorld4, level5, QPointF(550,568),QPointF(570,508),QPointF(580,508),QPointF(560,568), 0.0, b2_staticBody);
     recyclebin3 = new RecycleBinGraphics(level5);

     bottom= new MeinElement(myWorld4, level5, b2Vec2(0.0,level5->height()-200), level5->width(), 22, b2_staticBody, 0.1);
...
/*!
 * \brief Level_5::rotateLeft
 * possibility to rotate objects to the left
 */
void Level_5::rotateLeft(){
    qreal angle;
    if(counterRec==1){
        if(addblock1->graphics->isSelected()){
           ...
           // QPointF pos=addblock1->graphics->pos();
            ...
            level5->removeItem(addblock1->graphics);
            addblock1 =new Block(myWorld4, level5, b2Vec2 (50,20),angle , 100, 40, b2_staticBody,1.0,"tool");
    ...
    if(counterRec==2){
        ...
        if(addblock2->graphics->isSelected()){
           ...
           // QPointF pos=addblock2->graphics->pos();
            qreal degreeangle=angle*180/3.1415;
            level5->removeItem(addblock2->graphics);
            addblock2 =new Block(myWorld4, level5, b2Vec2 (50,20),angle , 100, 40, b2_staticBody,1.0,"tool");
    ...
    if(counterTriangle==1){
        if(addtriangle1->graphics->isSelected()){
            ...
            level5->removeItem(addtriangle1->graphics);
            addtriangle1 = new Triangle(myWorld4, level5, QPointF(0.0,0.0), QPointF(100.0,0.0), QPointF(100.0,100.0),angle, b2_staticBody, 1.0,"tool");
        }
    }
    ...
    if(counterTriangle==2){
        ...
        if(addtriangle1->graphics->isSelected()){
            ...
            level5->removeItem(addtriangle2->graphics);
            addtriangle2 = new Triangle(myWorld4, level5, QPointF(0.0,0.0), QPointF(100.0,0.0), QPointF(100.0,100.0),angle, b2_staticBody, 1.0,"tool");
...
/*!
 * \brief Level_5::rotateRight
 * possibility to rotate right
 */
void Level_5::rotateRight(){
    qreal angle;
    if(counterRec==1){
        if(addblock1->graphics->isSelected()){
            qreal angle=addblock1->angle+0.5235;
